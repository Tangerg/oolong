...
// with no appearance in it. [github.com/Tangerg/oolong/kit] is one set of answers to
...
//
// It is the same method set as [github.com/Tangerg/oolong/program.Component], so
